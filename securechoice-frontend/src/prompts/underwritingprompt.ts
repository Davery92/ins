export const underwritingprompt = (documentName: string) => `
...
●	End-of-chat verification mechanisms to confirm 80% understanding of the core underwriting principles for the domain.
Excluded:
...
●	Deep Research Execution: Conducting thorough investigation of the specified entity using the provided URL and other accessible information to gather data relevant to underwriting. For example, similar to how Talos's website was browsed to gather initial information1.
